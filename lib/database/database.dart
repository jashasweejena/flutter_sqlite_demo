...
class DBHelper {
  ...
  initDb() async{
    ...
    String path = join(documentsDirectory.path, "test.dn");
    var theDb = await openDatabase(path, version: 1, onCreate: _onCreate);
    return theDb;
  }

  //Create a table named Employee with fields
  void _onCreate(Database db, int version) async {
    //When creating the db create the table
    String _createTableQuery = "CREATE TABLE Employee(id INTEGER PRIMARY KEY, firstname TEXT, lastname TEXT, mobileno TEXT, emailid TEXT)";
    await db.execute(_createTableQuery);
    print("Created tables");
  }

  //Retrieving employees from employee table
